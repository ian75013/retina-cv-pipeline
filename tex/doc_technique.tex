...
\begin{center}
\begin{tikzpicture}[
  folder/.style={draw=accent!60, fill=accent!5, rounded corners=2pt, minimum width=3cm, minimum height=0.6cm, font=\small\ttfamily},
  file/.style={draw=codeframe, fill=codebg, rounded corners=1pt, minimum width=3cm, minimum height=0.5cm, font=\small\ttfamily},
...
\node[folder, minimum width=4cm] {retinai-pipeline/}
  child { node[folder] {src/}
    child { node[folder, font=\tiny\ttfamily] {data/} }
    child { node[folder, font=\tiny\ttfamily] {models/} }
    child { node[folder, font=\tiny\ttfamily] {evaluation/} }
    child { node[folder, font=\tiny\ttfamily] {api/} }
  }
  child { node[folder] {configs/} }
  child { node[folder] {tests/} }
  child { node[folder] {docker/} };
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}[node distance=0.3cm and 1.5cm, every node/.style={font=\small}]
  \node[draw, fill=mygray, rounded corners, minimum width=2cm, minimum height=1cm] (in) {Image\\brute};
  \node[draw, fill=myblue!15, rounded corners, minimum width=2.2cm, minimum height=1cm, right=of in] (roi) {Extraction\\ROI};
  ...
  \node[draw, fill=myred!15, rounded corners, minimum width=2.2cm, minimum height=1cm, right=of clahe] (resize) {Resize +\\Normalize};
...
\begin{enumerate}[leftmargin=2em]
  \item \textbf{Augmentations pixel-level} : rotations ($0°$, $90°$, $180°$, $270°$), flips horizontal/vertical, ajustements légers de luminosité, contraste et saturation.
...
\begin{center}
\begin{tikzpicture}[
  block/.style={draw, rounded corners=3pt, minimum width=2.5cm, minimum height=1cm, font=\small, align=center},
